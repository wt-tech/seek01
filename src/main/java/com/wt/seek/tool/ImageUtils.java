...
public class ImageUtils {
	...
	public static String generateAbsoluteImgPath(String realStaticsPath,String tableName,int id, String suffix) {
		String absolutePath = realStaticsPath + Constants.ContextPath + File.separator 
								+ tableName + "/" + id + suffix;
		return absolutePath;
	}
	...
	public static String genrateVirtualImgPath(String tableName,int id, String suffix) {
		String virtualPath = Constants.imgServerDomain + Constants.ContextPath + File.separator 
								+ tableName + File.separator + id + suffix;
		return virtualPath;
	}
